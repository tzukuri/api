$(function() {
    ...
    var score = parseInt($('#details-container').attr('data-score'))
    var responsePoints = parseInt($('#details-container').attr('data-response-points'))
    var topThreshold = parseInt($('#details-container').attr('data-top-threshold'))
    var numThresholdUsers = parseInt($('#details-container').attr('data-threshold-users'))
